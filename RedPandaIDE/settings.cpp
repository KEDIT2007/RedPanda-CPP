...
# endif
    ...
    mFormatterPath = includeTrailingPathDelimiter(pSettings->dirs().appLibexecDir())+"clang-format";
...
QString Settings::Environment::formatterPath() const
{
    return mFormatterPath;
}

void Settings::Environment::setFormatterPath(const QString &newFormatterPath)
{
    mFormatterPath = newFormatterPath;
}
...
#endif
    saveValue("formatter_path",mFormatterPath);
...
void Settings::CodeFormatter::setBaseStyle(const QString &newBaseStyle)
{
    mBaseStyle = newBaseStyle;
}
