...
public:
    ...
    public:
        ...
        QString formatterPath() const;
        void setFormatterPath(const QString &newFormatterPath);
    ...
    public:
        ...
        QString baseStyle() const;
        void setBaseStyle(const QString &newBaseStyle);
